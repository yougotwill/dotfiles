...
alias bupdate='brew update --quiet && brew outdated --formula && brew outdated --cask --greedy-auto-updates'
alias bu='bupdate'
alias bupgradefonts='brew list --cask | grep font- | xargs brew upgrade --fetch-HEAD --greedy --quiet'
alias bup='bupgrade'
alias bupf='bupgradeforce'
alias bcup='brew cu --no-brew-update --all --yes --quiet'
...
alias jeancli='/Applications/Jean.app/Contents/MacOS/jean'
alias jeanweb='/Applications/Jean.app/Contents/MacOS/jean --headless --host $(tailscale ip --1) --port 3456'
alias k='kitten'
alias mpva='mpv --no-video'
alias oc='opencode'
alias panerulogs='e /tmp/com.github.karinushka.paneru*.log'
